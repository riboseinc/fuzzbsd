...
timecounter: Timecounter "TSC" frequency 2294846450 Hz quality 3000
...
trap type 1 code 0 rip ffffffff802825bd cs 8 rflags 246 cr2 7f7ff70a1bd0 ilevel 0 rsp fffffe8002187a50
curlwp 0xfffffe8001a86240 pid 419.1 lowest kstack 0xfffffe80021852c0
Stopped in pid 419.1 (mount_msdos) at   netbsd:breakpoint+0x5:  leave   
db{0}> trace
...
r13         fffffe8002187a88
r14         0
r15         fffffe8003962b40
rip         ffffffff802825bd    breakpoint+0x5
cs          8
rflags      246
rsp         fffffe8002187a50
ss          10
netbsd:breakpoint+0x5:  leave   
db{0}> ps
PID    LID S CPU     FLAGS       STRUCT LWP *               NAME WAIT    
419  >   1 7   0         0   fffffe8001a86240        mount_msdos         
66       1 3   0        80   fffffe8003a981a0              mount wait    
398      1 3   0        80   fffffe8001e12a60                 sh wait    
646      1 3   0        80   fffffe8003b4b180                 sh wait    
48       1 3   0        80   fffffe8003061a20                gdb select  
41       1 3   0        80   fffffe8003b20a00                 sh wait    
702      1 3   0        80   fffffe8003a985c0                 sh wait    
628      1 3   0        80   fffffe8003a989e0               sshd select  
487      1 3   0        80   fffffe8003061600               sshd select  
693      1 3   0        80   fffffe8003b4b9c0              getty ttyraw  
698      1 3   0        80   fffffe8003b4b5a0              getty ttyraw  
685      1 3   0        80   fffffe8003dd4160              getty ttyraw  
699      1 3   0        80   fffffe80015ea0e0              login wait    
665      1 3   0        80   fffffe8002a64200               cron nanoslp 
516      1 3   0        80   fffffe80030611e0              inetd kqueue  
499      1 3   0        80   fffffe8001e12220               qmgr kqueue  
645      1 3   0        80   fffffe8001e12640             pickup kqueue  
637      1 3   0        80   fffffe8001a86a80             master kqueue  
210      1 3   0        80   fffffe8002a64a40               sshd select  
376      1 3   0        80   fffffe8002a64620             powerd kqueue  
220      1 2   0         0   fffffe8003b205e0            syslogd         
108      1 3   0        80   fffffe8003b201c0             dhcpcd select  
1        1 3   0        80   fffffe8001757960               init wait    
0       47 3   0       200   fffffe8001a86660               vnd0 vndbp   
