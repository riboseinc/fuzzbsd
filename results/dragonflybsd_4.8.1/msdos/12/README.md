...
i8254 clock: 1193197 Hz
TSC invariant clock: 2294696856 Hz
...
lapic: divisor index 0, frequency 500004517 Hz
srat_probe: can't locate SRAT
SMI Frequency (worst case): 22727 Hz (44 us)
Initialize MI interrupts
TSC: cputimer freq 71709276, shift 5
...
<118>/dev/serno/VB72453a18-bfd99f8c.s1d: 
<118>clean, 11946365 free 
<118>(2773 frags, 1492949 blocks, 0.0% fragmentation)
...
<118>Aug 14 21:04:14 foobar syslogd: kernel boot file is /boot/kernel/kernel
...
<118>
<118>Mon Aug 14 21:04:15 HKT 2017
panic: getblk: size(98304) > MAXBSIZE(65536)
cpuid = 0
Trace beginning at frame 0xffffff8051d782b8
panic() at panic+0x236 0xffffffff805e5e66 
panic() at panic+0x236 0xffffffff805e5e66 
getblk() at getblk+0x519 0xffffffff80651e39 
breadnx() at breadnx+0x266 0xffffffff80652156 
...
[New kernel syncer14]
[New pid 966/0, mount_msdos]
[New pid 965/0, mount]
[New pid 957/0, csh]
[New pid 951/0, sshd]
[New pid 512/0, syslogd]
[New pid 411/0, dhclient]
[New pid 944/0, getty]
[New pid 943/0, getty]
[New pid 942/0, getty]
[New pid 941/0, getty]
...
[New pid 818/0, sshd]
[New pid 436/0, devd]
[New pid 289/0, dhclient]
[New pid 288/0, dhclient]
[New kernel syncer13]
[New kernel syncer12]
[New kernel syncer5]
...
#1  panic (fmt=fmt@entry=0xffffffff80b2f300 "getblk: size(%d) > MAXBSIZE(%d)") at /home/justin/release/4_8/sys/kern/kern_shutdown.c:833
#2  0xffffffff80651e39 in getblk (vp=<optimized out>, loffset=32768, size=98304, blkflags=0, slptimeo=<optimized out>)
    at /home/justin/release/4_8/sys/kern/vfs_bio.c:2803
#3  0xffffffff80652156 in breadnx (vp=0xffffff8051aa0e60, loffset=<optimized out>, size=<optimized out>, raoffset=raoffset@entry=0x0, 
    rabsize=rabsize@entry=0x0, cnt=cnt@entry=0, bpp=0xffffff8051d78450) at /home/justin/release/4_8/sys/kern/vfs_bio.c:938
#4  0xffffffff80687cd4 in bread (bpp=0xffffff8051d78450, size=<optimized out>, loffset=<optimized out>, vp=<optimized out>)
    at /home/justin/release/4_8/sys/sys/buf2.h:356
#5  fillinusemap (pmp=pmp@entry=0xffffff80493e9740) at /home/justin/release/4_8/sys/vfs/msdosfs/msdosfs_fat.c:904
#6  0xffffffff8068a829 in mountmsdosfs (argp=0xffffff8051d78580, mp=0xffffff804eb1ddc0, devvp=0xffffff8051aa0e60)
    at /home/justin/release/4_8/sys/vfs/msdosfs/msdosfs_vfsops.c:590
#7  msdosfs_mount (mp=0xffffff804eb1ddc0, path=<optimized out>, data=<optimized out>, cred=0xffffff8040749d48)
    at /home/justin/release/4_8/sys/vfs/msdosfs/msdosfs_vfsops.c:280
#8  0xffffffff8067cefa in vfs_mount (mp=0xffffff804eb1ddc0, path=0x7fffffffe210 <Address 0x7fffffffe210 out of bounds>, 
    data=0x7fffffffe6a0 <Address 0x7fffffffe6a0 out of bounds>, cred=0xffffff8040749d48) at /home/justin/release/4_8/sys/kern/vfs_vfsops.c:93
#9  0xffffffff806729fd in sys_mount (uap=<optimized out>) at /home/justin/release/4_8/sys/kern/vfs_syscalls.c:380
#10 0xffffffff80a5c786 in syscall2 (frame=0xffffff8051d789f8) at /home/justin/release/4_8/sys/platform/pc64/x86_64/trap.c:1228
#11 0xffffffff80a4428b in Xfast_syscall () at /home/justin/release/4_8/sys/platform/pc64/x86_64/exception.S:323
