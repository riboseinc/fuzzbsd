...
i8254 clock: 1193189 Hz
TSC invariant clock: 2294703305 Hz
...
lapic: divisor index 0, frequency 500004435 Hz
srat_probe: can't locate SRAT
SMI Frequency (worst case): 38461 Hz (26 us)
Initialize MI interrupts
TSC: cputimer freq 71709478, shift 5
...
<118>/dev/serno/VB72453a18-bfd99f8c.s1d: 
<118>clean, 11946331 free 
<118>(2803 frags, 1492941 blocks, 0.0% fragmentation)
...
<118>Aug 14 21:27:15 foobar syslogd: kernel boot file is /boot/kernel/kernel
...
fault virtual address	= 0xffffff8041e9a004
fault code		= supervisor read data, page not present
instruction pointer	= 0x8:0xffffffff80687ba7
stack pointer	        = 0x10:0xffffff8051dae438
frame pointer	        = 0x10:0xffffff8051dae488
...
[New kernel syncer14]
[New pid 963/0, mount_msdos]
[New pid 962/0, mount]
[New pid 411/0, dhclient]
[New pid 501/0, syslogd]
[New pid 945/0, csh]
[New pid 944/0, getty]
[New pid 943/0, getty]
[New pid 942/0, getty]
...
#6  0xffffffff80a54576 in kdb_trap (type=type@entry=12, code=code@entry=0, regs=regs@entry=0xffffff8051dae368)
    at /home/justin/release/4_8/sys/platform/pc64/x86_64/db_interface.c:176
#7  0xffffffff80a5afaf in trap_fatal (frame=frame@entry=0xffffff8051dae368, eva=<optimized out>)
    at /home/justin/release/4_8/sys/platform/pc64/x86_64/trap.c:1018
#8  0xffffffff80a5b3ff in trap_pfault (frame=0xffffff8051dae368, usermode=0) at /home/justin/release/4_8/sys/platform/pc64/x86_64/trap.c:923
#9  0xffffffff80a5b8da in trap (frame=0xffffff8051dae368) at /home/justin/release/4_8/sys/platform/pc64/x86_64/trap.c:603
#10 0xffffffff80a4403f in calltrap () at /home/justin/release/4_8/sys/platform/pc64/x86_64/exception.S:188
#11 0xffffffff80687ba7 in fillinusemap (pmp=pmp@entry=0xffffff80493e9740) at /home/justin/release/4_8/sys/vfs/msdosfs/msdosfs_fat.c:913
#12 0xffffffff8068a829 in mountmsdosfs (argp=0xffffff8051dae580, mp=0xffffff804eb1ddc0, devvp=0xffffff8051aa0e60)
    at /home/justin/release/4_8/sys/vfs/msdosfs/msdosfs_vfsops.c:590
#13 msdosfs_mount (mp=0xffffff804eb1ddc0, path=<optimized out>, data=<optimized out>, cred=0xffffff8040749820)
    at /home/justin/release/4_8/sys/vfs/msdosfs/msdosfs_vfsops.c:280
#14 0xffffffff8067cefa in vfs_mount (mp=0xffffff804eb1ddc0, path=0x7fffffffe310 <Address 0x7fffffffe310 out of bounds>, 
    data=0x7fffffffe7a0 <Address 0x7fffffffe7a0 out of bounds>, cred=0xffffff8040749820) at /home/justin/release/4_8/sys/kern/vfs_vfsops.c:93
#15 0xffffffff806729fd in sys_mount (uap=<optimized out>) at /home/justin/release/4_8/sys/kern/vfs_syscalls.c:380
#16 0xffffffff80a5c786 in syscall2 (frame=0xffffff8051dae9f8) at /home/justin/release/4_8/sys/platform/pc64/x86_64/trap.c:1228
#17 0xffffffff80a4428b in Xfast_syscall () at /home/justin/release/4_8/sys/platform/pc64/x86_64/exception.S:323
